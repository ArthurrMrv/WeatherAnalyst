...
days.saveCorrelationMatrix("/Users/arthurmorvan/Desktop/Final_Project/correlation_matrix.png", *list(days.getCityNames()))

#display an image on the tkinter window
canvas = tk.Canvas(window, width = 1000, height = 800)
canvas.pack()
img = tk.PhotoImage(file="/Users/arthurmorvan/Desktop/Final_Project/correlation_matrix.png")
